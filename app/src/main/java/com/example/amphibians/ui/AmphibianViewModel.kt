...
class AmphibianViewModel : ViewModel() {
    ...
    private val _amphibiansData = MutableLiveData<List<Amphibian>>()
    val amphibiansData: LiveData<List<Amphibian>> = _amphibiansData

    // TODO: Create properties to represent MutableLiveData and LiveData for a single amphibian object.
    //  This will be used to display the details of an amphibian when a list item is clicked
    private val _displayedAmphibian = MutableLiveData<Amphibian>()
    val displayedAmphibian: LiveData<Amphibian> = _displayedAmphibian
    ...
    fun getAmphibianList() {
        viewModelScope.launch() {
            try {
                ...
                _amphibiansData.value = AmphibianApi.retrofitService.getAmphibiansList()
    ...
    fun onAmphibianClicked(amphibian: Amphibian) {
        ...
        _displayedAmphibian.value = amphibian
    }
}
